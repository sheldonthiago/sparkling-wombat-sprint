...
import { Plus, Printer, Package, AlertTriangle, CheckCircle } from 'lucide-react';
...
export function PrinterSupplyManager({ supplies, onAddSupply, onUpdateSupply }: PrinterSupplyManagerProps) {
              ...
              <Card key={supply.id} className={isOut ? 'border-red-200 bg-red-50' : needsReorder ? 'border-yellow-200 bg-yellow-50' : ''}>
                ...
                <CardContent>
                  ...
                  {supply.nextPurchaseDate && (
                    <div className="mb-4">
                      <p className="text-sm text-gray-500">Próxima Com Prevista</p>
